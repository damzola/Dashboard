  ...
  return (
    ...
    <div className="d-block d-flex bg-white shadow-lg rounded-start-4">
      ...
      <div
        ...
        style={{ width: "15%", height: "100vh", backgroundColor: "#008080"}}
      >
      ...
      {/* Main content */}
        ...
        {/* Actual page content */}
        <div style={{width: "75%"}} className=' position-relative justify-content-center align-items-center text-center '>
